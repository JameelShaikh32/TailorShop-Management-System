...
public class splash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Home/images/splashscreen.png"))); // NOI18N

        progress.setBackground(new java.awt.Color(255, 255, 255));
        progress.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        progress.setForeground(new java.awt.Color(255, 255, 102));
    ...
    public static void main(String args[]) {
        ...
        try{
            for(int i = 0; i <= 100; i++){
                ...
                sp.progress.setStringPainted(true);
                sp.progress.setString("Loading...");
